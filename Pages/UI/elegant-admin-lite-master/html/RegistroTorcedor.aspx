<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroTorcedor.aspx.cs" Inherits="Pages.UI.elegant_admin_lite_master.html.RegistroTorcedor" %>
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="input-group form-group">
                                ...
                                <asp:TextBox ID="txtNomeT" runat="server" class="form-control" placeholder="Nome completo"></asp:TextBox>
                            ...
                            <div class="input-group form-group">
                                ...
                                <asp:TextBox ID="txtRGT" runat="server" class="form-control" placeholder="RG" MaxLength="9" ></asp:TextBox>
                            ...
                            <asp:TextBox ID="txtCPFT" runat="server" class="form-control" placeholder="CPF" MaxLength="11"></asp:TextBox>
                            </div>
                            <!--========================================ETEC=====================================================-->
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group form-group">
                                ...
                                <asp:TextBox ID="txtEmailT" runat="server" class="form-control" placeholder="E-mail" TextMode="Email"></asp:TextBox>
                            </div>
                            ...
                            <asp:TextBox ID="txtDataNascT" runat="server" class="form-control" placeholder="Data de nascimento" ></asp:TextBox>
                            ...
                            <div class="input-group form-group">
                                ...
                                <!--<asp:TextBox ID="txtAnoLetivo" runat="server" class="form-control"  placeholder="Série/Módulo"></asp:TextBox>-->
                                <asp:DropDownList ID="ddlAN" runat="server" class="form-control">
                            ...
                            <div class="input-group form-group">
                                ...
                                <asp:TextBox ID="txtRMT" runat="server" class="form-control" placeholder="RM" TextMode="Number"></asp:TextBox>
                            </div>
                            <!--========================================SENHA=====================================================-->
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                ...
                                <asp:TextBox ID="txtSenhaT" runat="server" class="form-control" placeholder="Senha" TextMode="Password"></asp:TextBox>
                            </div>


                           
                            <div class="form-group">
                            <asp:Button ID="btnCadT" runat="server" Text="Pronto!" class="btn float-right login_btn" OnClick="btnCadA_Click"></asp:Button>
