<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvisosAdm.aspx.cs" Inherits="Pages.UI.elegant_admin_lite_master.html.AvisosAdm" %>
                    ...
                    <div class="scroll-sidebar">
                        ...
                        <nav class="sidebar-nav">
                            <ul id="sidebarnav">
                                ...
                                <li><a class="waves-effect waves-dark" href="Chavemento.aspx" aria-expanded="false"><i class="fa fa-table"></i><span class="hide-menu"></span>Chaveamento</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Avisos & Noticias</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Avisos & Noticias</li>
                            </ol>
