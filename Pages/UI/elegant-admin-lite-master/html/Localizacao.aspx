<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Localizacao.aspx.cs" Inherits="Pages.UI.elegant_admin_lite_master.html.Localizacao" %>
    ...
    <form id="form1" runat="server">
        <div>
            <div class="topnav">
                ...
                <a class="IdentPage" href="Localizacao.aspx">Localiza&ccedil;&atilde;o</a>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group form-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-user"></i><img src="IMG/people.png" width="25px" height="25px"/></span>
                                                </div>
                                            ...
                                            <div class="input-group form-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i class="fas fa-key"></i><img src="IMG/lock.png" width="25px" height="25px"/></span>
                                                </div>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="about">
                            &nbsp;<table>
                                <tr>
                                    <td>
                                        &nbsp;<img src="IMG/LogoCirc.png" height="65px" width="65px" /></td>

                                    <td>
                                       <b> <h3> &nbsp;Localiza&ccedil;&atilde;o</h3></b>
                                    </td>
                                </tr>
                            </table><center>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3662.628780591949!2d-46.74563308506025!3d-23.36545988478053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cee49b530782cb%3A0x7856142831d858c5!2sEst%C3%A1dio+Municipal+Carlos+Ferracini!5e0!3m2!1spt-BR!2sbr!4v1565361278915!5m2!1spt-BR!2sbr" width="700" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                                </center>
